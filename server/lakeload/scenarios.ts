...
export const SCENARIOS: ScenarioDefinition[] = [
  {
    ...
    method: 'Parameterized primary-key lookups against a warm, indexed account table.',
  ...
  },
  {
    ...
    method: 'Join one account to its recent events and aggregate a bounded history window.',
